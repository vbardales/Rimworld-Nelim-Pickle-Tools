<#
.SYNOPSIS
  Compile the step patterns of the sound capture steps with Pickle's own expression engine, and check
...
.EXAMPLE
  powershell.exe -ExecutionPolicy Bypass -File PickleTools/SoundCapture/Check-Steps.ps1
#>
param(
...
$mine = @(Read-Patterns (Join-Path $here 'Source') 'shared:SoundCapture')
