...
- **Long.** The world, the map and the colonists are generated by the game under the software renderer: minutes, on the machine every session shares.
...
- **Not played yet** (2026-09-25): the first run is the probe, and this file says nothing about it until it has answered.
