...
remaining:
  ...
  - "pending, 2026-09-23: a bundle-level RIMMSQOL-present, main-menu bridge probe was added and queued in English behind the VEF French replay. It only checks optional-mod activation and bridge readiness; it does not test settings mutation or restart. The global RimmsqolSteps expression checker currently fails on two unrelated studio phrases in another suite, so no green global checker claim is made for this addition."
