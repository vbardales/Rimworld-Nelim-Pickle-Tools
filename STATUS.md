...
remaining:
  ...
  - "pending, 2026-09-23: QuietNewFactions' test companion now declares and tags the aggregate bundle rather than the standalone VEF steps; its five-scenario English VEF-present replay on Pickle v4.8.4 was queued. Offline expression check passed, but no result from the new replay is claimed here."
